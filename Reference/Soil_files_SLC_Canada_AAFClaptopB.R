...
library("foreign", lib.loc="~/R/R-3.3.2/library")
library("stringr", lib.loc="~/R/R-3.3.2/library")
SLC_soils <- (read.dbf("C:/Users/cordeirom/Documents/WFP/Soils/soil_name_canada_v2r20140529.dbf"))
SN_id_unique <- as.vector(unique(SLC_soils$SOIL_ID))
SN <- read.dbf("C:/Users/cordeirom/Documents/WFP/Soils/soil_name_canada_v2r20140529.dbf")
SL <- read.dbf("C:/Users/cordeirom/Documents/WFP/Soils/soil_layer_canada_v2r20140529.dbf")
...
Columns <- read.csv("C:/Users/cordeirom/Documents/Manuscripts/Man02_Soils_SWAT_Can/Files/colnames_COMP.csv", header=FALSE, stringsAsFactors=FALSE)
...
write.csv(COMP,"C:/Users/cordeirom/Documents/Manuscripts/Man02_Soils_SWAT_Can/Files/SLCsoils_SWAT_COMPLETE.csv", row.names = FALSE)